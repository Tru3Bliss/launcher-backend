...
export const SideButton = (props) => {
  ...
  return (
    <Link to={target}>
      <div className={`flex hover:scale-[1.02] text-xl duration-500 items-center rounded-l-full rounded-r-lg border-white w-full text-white font-bold px-2 border-r-0 py-2 gap-4 ${location.pathname === target ?"bg-slate-900":"bg-slate-700"}  shadow-xl`}>
